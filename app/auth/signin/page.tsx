      ...
      <div className="w-full max-w-md">
        ...
        <div className="rounded-3xl p-8" style={{ background: "var(--card)", border: "1px solid var(--border)" }}>
          ...
          <form onSubmit={handleSignIn} className="flex flex-col gap-4">
            ...
            <div>
              <div className="flex justify-between items-center mb-1.5">
                ...
                <button type="button" className="text-xs hover:opacity-80" style={{ color: "var(--primary-light)" }}>
                  Forgot password?
                </button>
              </div>
          ...
          <p className="text-center text-sm mt-5" style={{ color: "var(--muted)" }}>
            ...
            <Link href="/auth/register" className="font-medium hover:opacity-80" style={{ color: "var(--primary-light)" }}>
              Create one free
            </Link>
          </p>
        </div>
